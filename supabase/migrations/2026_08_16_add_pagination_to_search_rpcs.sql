-- Tambah parameter pagination p_offset & p_limit pada RPC pencarian produk.
-- Latar belakang: PostgREST membatasi 1000 baris per respons dan mengabaikan
-- header Range pada pemanggilan RPC via POST. Dengan parameter di sisi SQL,
-- klien dapat mengambil seluruh hasil secara berhalaman.
-- p_limit NULL (default) = tanpa limit (perilaku lama), p_offset NULL = 0.

-- 1) search_onderdil_products (halaman /onderdil) - model ALLOWLIST visibilitas
...
-- 2) search_and_sort_products (halaman Pilok & lainnya)
